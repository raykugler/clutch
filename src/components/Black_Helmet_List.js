...
class Black_Helmet_List extends React.Component {
    constructor(props){
        super(props)
        this.state={blackstate: 'black'
    }
}
    ...
    render(clutches){
        ...
        {({loading, error, data}) =>{
           ...
           return data.clutches.filter(clutch => clutch[this.state.blackstate]
...
export default Black_Helmet_List;
