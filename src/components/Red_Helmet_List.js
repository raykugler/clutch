...
class Red_Helmet_List extends React.Component {
    constructor(props){
        super(props)
        this.state={redstate: 'red'
    }
}
    ...
    render(clutches){
        ...
        {({loading, error, data}) =>{
           ...
           return data.clutches.filter(clutch => clutch[this.state.redstate]
...
export default Red_Helmet_List;
