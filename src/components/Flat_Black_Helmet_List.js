...
class Flat_Black_Helmet_List extends React.Component {
    constructor(props){
        super(props)
        this.state={flatblackstate: 'flatblack'
    }
}
    ...
    render(clutches){
        ...
        {({loading, error, data}) =>{
           ...
           return data.clutches.filter(clutch => clutch[this.state.flatblackstate]
...
export default Flat_Black_Helmet_List;
