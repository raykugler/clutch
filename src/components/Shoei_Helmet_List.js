...
class Shoei_Helmet_List extends React.Component {
    constructor(props){
        super(props)
        this.state={shoeistate: 'shoei'
    }
}
    ...
    render(clutches){
        ...
        {({loading, error, data}) =>{
           ...
           return data.clutches.filter(clutch => clutch[this.state.shoeistate]
...
export default Shoei_Helmet_List;
