...
class Gold_Helmet_List extends React.Component {
    constructor(props){
        super(props)
        this.state={goldstate: 'gold'
    }
}
    ...
    render(clutches){
        ...
        {({loading, error, data}) =>{
           ...
           return data.clutches.filter(clutch => clutch[this.state.goldstate]
...
export default Gold_Helmet_List;
