...
class Full_Face_Helmet_List extends React.Component {
    constructor(props){
        super(props)
        this.state={fullfacestate: 'typeFullFace'
    }
}
    ...
    render(clutches){
        ...
        {({loading, error, data}) =>{
           ...
           return data.clutches.filter(clutch => clutch[this.state.fullfacestate]
...
export default Full_Face_Helmet_List;
