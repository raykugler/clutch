...
class Three_Quarter_Helmet_List extends React.Component {
    constructor(props){
        super(props)
        this.state={type34state: 'type34'
    }
}
    ...
    render(clutches){
        ...
        {({loading, error, data}) =>{
           ...
           return data.clutches.filter(clutch => clutch[this.state.type34state]
...
export default Three_Quarter_Helmet_List;
